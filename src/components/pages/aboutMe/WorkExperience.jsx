    ...
    <section id="work-experience" className="max-w-[860px] mx-auto px-10 py-12">
      ...
      <div className="grid grid-cols-1 gap-4">
        {WORK_EXPERIENCE.map((job) => (
          <div key={job.id} className="bg-white border dark:bg-[#1A1814] border-[#D9D4C9] rounded-[14px] p-6 hover:shadow-[0_6px_24px_rgba(0,0,0,0.07)] hover:-translate-y-[2px] transition-all duration-200">
            <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-2 mb-3">
              <div>
                <h3 className="text-[16px] font-medium text-[#1A1814] dark:text-[#F7F5F0]">{job.role}</h3>
